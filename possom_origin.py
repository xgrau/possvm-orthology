...
arp.add_argument("-g", "--gcol",  required=False, default="node",       help="OPTIONAL: name of gene column in --in/-i table. Default is \"node\"")
arp.add_argument("-c", "--ccol",  required=False, default="og_cluster", help="OPTIONAL: name of orthogroup column in --in/-i table. Default is \"og_cluster\"")
